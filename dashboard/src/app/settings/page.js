        ...
        <div className="p-8 max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="glass-card overflow-hidden">
                    <div className="p-6 border-b border-foreground/5 flex items-center gap-3 bg-foreground/[0.02]">
                        ...
                        <h2 className="font-bold font-outfit uppercase tracking-wider text-sm">Account Profile</h2>
                    </div>
                ...
                <div className="glass-card overflow-hidden">
                    <div className="p-6 border-b border-foreground/5 flex items-center gap-3 bg-foreground/[0.02]">
                        ...
                        <h2 className="font-bold font-outfit uppercase tracking-wider text-sm">Notifications</h2>
                    </div>
            ...
            <div className="flex justify-end gap-4 pb-12 pt-4">
                <button
                    ...
                    className="px-8 py-3 rounded-2xl font-bold bg-foreground/5 hover:bg-foreground/10 transition-all font-outfit text-sm active:scale-95"
                >
                    Cancel
                </button>
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="px-10 py-3 rounded-2xl font-bold bg-primary text-background flex items-center gap-2 shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all font-outfit text-sm disabled:opacity-50"
                >
...
function SettingToggle({ label, description, checked, onChange }) {
    return (
        <div className="flex items-center justify-between group">
            <div>
                <p className="text-sm font-bold font-inter group-hover:text-primary transition-colors">{label}</p>
                <p className="text-[11px] text-muted font-inter">{description}</p>
            </div>
